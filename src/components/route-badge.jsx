 ...
 * @param {boolean} [props.interactive=true] - When false, disables click/hover; use for badges
 *   inside dropdowns or other interactive containers where the badge is purely decorative.
 */

const api = window.SubwayBuilderAPI;
const { React } = api.utils;

export function RouteBadge({ routeId, size = '2rem', interactive = true }) {
    // Get route data
    ...
    // Only add pointer / hover when the badge is interactive
